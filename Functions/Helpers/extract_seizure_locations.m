function [seizure_samples, overflow_start, overflow_end] = extract_seizure_locations(events, N, fs, buffered_start, buffered_end, is_looped, start_sample, end_sample)
